package com1.fladykhw.jdbc.template;
...
import com1.fladykhw.jdbc.raw.Article;
import com1.fladykhw.jdbc.raw.ArticleDao;
...
public class ArticleDaoImplUsingTemplate implements ArticleDao {
	...
	public ArticleDaoImplUsingTemplate() {
		dataSource = new MariaDbDataSource(
				"jdbc:mariadb://localhost:3306/FoolLady?user=FoolLady&password=151208");
